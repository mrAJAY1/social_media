...
import { createTheme, Grid, styled, MenuItem, Select, selectClasses, inputClasses, ThemeProvider, Typography } from '@mui/material'
                ...
                <AnimateBR>
                    <div className={Style.step3Wrapper}>
                        <div className={Style.childWrapper} >
                            <small>Username is your identity here. &#160;Make it unique.</small>
                            <div className={Style.formWrapper}>
                                <label>Username</label>
                                <div className={Style.inputWrapper} >
                                    <input name='username' type="text" placeholder='try a username' />
                                </div>
                            </div>
                            <AnimateUtoD>
                                <ThemeProvider theme={theme}>
                            ...
                            <div className={Style.formWrapper} style={{ padding: '0' }}>
                                <div className={Style.inputWrapper} >
                                    <label style={{ paddingLeft: "0.7rem" }} htmlFor="">select username</label>
                                    <StyledSelect fullWidth sx={{ height: '20px', borderBottom: '1px solid white' }} variant='standard' >
