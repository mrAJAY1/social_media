import { Button, createTheme, Grid, Link, ThemeProvider, Typography } from '@mui/material'
                ...
                <AnimateBR>
                    <div className={Style.step2Wrapper}>
                        <div className={Style.childWrapper} >
                            <img style={{ width: '100%', height: '80%' }} src={Connect} alt="" />
                            <Grid container sx={{ display: 'flex', justifyContent: 'center' }}>
                                <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center', marginBottom: { xs: '20px', md: '30px' } }}>
                                    <ThemeProvider theme={theme}>
                                ...
                                <Grid item md={12} sx={{ display: 'flex', justifyContent: 'center', marginBottom: '30px' }}>
                                    <BackBtn onClick={decrement} style={{marginRight:'10px'}} variant='standard'>Go back &#160;<VscArrowLeft /></BackBtn>
                                    <Gobtn variant='outlined'><VscArrowRight className={Style.nextArrow} /></Gobtn>
